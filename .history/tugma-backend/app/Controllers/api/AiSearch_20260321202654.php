...
class AiSearch extends ResourceController
{
    ...
    public function searchMatches()
    {
        try {
            ...
            // 🔥 FIX 1: Direct DB connection prevents crashes if EmployerJobModel is missing
            ...
            $apiKey = 'AIzaSyBaNRfKXf4WpoaA4aS7p4btJlUwohHZ_FA'; 
            ...
            // 🔥 FIX 2: \Throwable catches EVERYTHING, preventing a silent 500 HTML crash
