...
class Applications extends ResourceController
{
    ...
    public function getEmployerApplicants($employer_uid = null)
    {
        ...
        try {
            ...
            // 🔥 Make sure the aliases (ej, u, sp) are here!
            ...
            // 🔥 This will send the EXACT SQL crash message back to your React console
            return $this->failServerError('DB Query Failed: ' . $e->getMessage());
        }
    }
