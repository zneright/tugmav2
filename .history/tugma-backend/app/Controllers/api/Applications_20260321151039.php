...
class Applications extends ResourceController
{
    ...
    public function getEmployerApplicants($employer_uid = null)
    {
        ...
        try {
            ...
            // 🛑 VERIFY: Does "resume_data" actually exist in your table? 
            // If it's called "resume_file", change this to: sp.resume_file as resume_data
            ...
            // 🔥 This forces CodeIgniter to send the EXACT error message to React
