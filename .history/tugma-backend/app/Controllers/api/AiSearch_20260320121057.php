...
class AiSearch extends ResourceController
{
    ...
    public function searchMatches()
    {
        try {
            ...
            // 🔥 CRITICAL FIX: Using the ultra-stable 1.5-flash model
            $url = 'https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key=' . $apiKey;

            $prompt = "YOU ARE AN ADVANCED AI JOB MATCHMAKER. Analyze the available jobs against the user's input. OUTPUT ONLY RAW VALID JSON ARRAY.
            ...
            if (!is_array($aiMatches)) {
                throw new \Exception('AI Engine failed to format the response correctly.');
            }
