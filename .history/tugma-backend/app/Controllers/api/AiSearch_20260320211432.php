...
class AiSearch extends ResourceController
{
    ...
    public function searchMatches()
    {
        try {
            ...
            // Force valid JSON encoding
            $safeJobsJson = json_encode($simplifiedJobs, JSON_PARTIAL_OUTPUT_ON_ERROR);

            $apiKey = 'AIzaSyCke-i5eBILEIsjGtei4M8PyO7RrMhZ1Mk'; 
            
            // 🔥 Using 1.5-flash: It is much more stable for pure JSON formatting!
            $url = 'https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key=' . $apiKey;

            $prompt = "YOU ARE AN ADVANCED AI JOB MATCHMAKER. Analyze the available jobs against the user's input. OUTPUT ONLY RAW VALID JSON ARRAY. NO CONVERSATIONAL TEXT.
            ...
            $data = [
                ...
                "generationConfig" => [
                    "temperature" => 0.7, // 🔥 NEW: Forces the AI to give fresh, dynamic answers every time
            ...
            // 🔥 THE ULTIMATE JSON FIX: Extract ONLY the array, ignore chatty text 🔥
            ...
            if (!is_array($aiMatches)) {
                throw new \Exception('AI Engine failed to format the response correctly. Raw String: ' . $aiText);
            }
