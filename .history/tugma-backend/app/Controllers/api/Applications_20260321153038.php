...
class Applications extends ResourceController
{
    ...
    public function getEmployerApplicants($employer_uid = null)
    {
        ...
        try {
            ...
            // 🔥 THE MAGIC FIX: sp.profile_data as resume_data 🔥
    ...
    public function analyzeApplicant($applicationId = null)
    {
        ...
        try {
            ...
            if (!empty($resumeUrl)) {
                try {
                    ...
                    if ($fileContent) {
                        ...
                        // 🔥 FIX: Bypassing mime_content_type so PHP doesn't crash 🔥
            ...
            // Check if we actually successfully extracted text from a file
