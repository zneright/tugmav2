    ...
    public function getRole($uid = null)
    {
        try {
            ...
            if ($user) {
                ...
                // If the user's email matches the Super Admin email, ALWAYS return "superadmin"
                if ($user->email === 'buday.313258@caloocan.sti.edu.ph' || $user->email === 'buday.3132578@caloocan.sti.edu.ph') {
                    $roleToReturn = 'superadmin';
                }
