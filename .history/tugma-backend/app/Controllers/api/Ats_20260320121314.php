...
class Ats extends ResourceController
{
    ...
    // --- NEW: FETCH HISTORY ENDPOINT ---
    public function history()
    {
        $model = new AtsHistoryModel();
        // Get the 10 most recent scans
        $history = $model->orderBy('created_at', 'DESC')->findAll(10);
        
        // Decode the JSON string back into an object for React
    ...
    private function gradeWithAI($resumeText, $jobDescription)
    {
        ...
        $apiKey = 'AIzaSyAa2P_yHJN0KDYc6byin7m6l6ISeUmsYTs'; 
