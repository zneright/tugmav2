...
class Users extends ResourceController
{
    ...
    public function getProfile($uid = null)
    {
        try {
            ...
            $response = [
                ...
                'resumeData'         => $data['profile_data'] ?? '', // Base64 storage
            ...
            // Catch the exact error and send it to React
            return $this->failServerError('GET Error: ' . $e->getMessage());
        }
    }
    ...
    public function updateProfile($uid = null)
    {
        try {
            ...
            if (!$data) {
                return $this->fail('Invalid JSON payload sent from frontend.');
            }
            ...
            // Catch the exact error (e.g., column missing, data too long)
