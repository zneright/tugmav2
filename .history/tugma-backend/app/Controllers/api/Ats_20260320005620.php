...
class Ats extends ResourceController
{
    ...
    public function scan()
    {
        ...
        try {
            ...
            // 👇 ADD THIS CHECK: Did the parser actually find any text? 👇
            if (trim($resumeText) === '') {
                return $this->failServerError('We could not read any text in this PDF. Please make sure it is a standard text document (like a Word export) and not an image or scanned file.');
            }
