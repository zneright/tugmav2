  ...
  public function getDashboardStats($studentUid = null)
{
    ...
    // 1. Get Application Status Counts (For the "Applied", "Hired" cards)
    ...
    // 2. Get Total Credited OJT Hours from dtr_logs
    ...
    $stats = [
        ...
        'pending' => 0, 
        'reviewed' => 0,
        'total_hours' => $totalCompletedHours // This is the "Real Print" data
    ];
