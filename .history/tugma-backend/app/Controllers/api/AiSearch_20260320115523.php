...
class AiSearch extends ResourceController
{
    ...
    public function searchMatches()
    {
        ...
        // Call Gemini AI - Using the most stable 1.5-flash endpoint
        ...
        // 🔥 STRICT ERROR HANDLING: If Google fails, tell React!
        if ($httpCode !== 200) {
        ...
        if (!$aiText) {
            return $this->failServerError('AI Engine returned an empty or blocked response.');
        }
