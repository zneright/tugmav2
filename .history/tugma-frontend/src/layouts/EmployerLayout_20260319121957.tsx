...
import { useLocation, Outlet } from 'react-router-dom'; // 👈 1. Imported useLocation
import EmployerSidebar from '../components/EmployerSidebar';
import Topbar from '../components/Topbar'; 
import FloatingChatWidget from '../components/FloatingChatWidget'; // 👈 2. Imported the widget
...
export default function EmployerLayout({ children }: EmployerLayoutProps) {
  ...
  const location = useLocation(); // 👈 3. Track the URL
