...
import { Mail, Briefcase, ShieldAlert, Lock, X, ArrowLeft, AlertCircle, User, Building, Users } from 'lucide-react';
...
export default function Auth() {
  ...
  return (
    <div className="h-screen w-full flex font-sans bg-[#0a0310] relative overflow-hidden">
      ...
      {/* =========================================
          RIGHT SIDE: FORM AREA (FLEX COLUMN LAYOUT)
          ========================================= */}
      <div className="w-full lg:w-1/2 h-full flex flex-col bg-[#0a0310]">

        {/* --- TOP NAV HEADER --- */}
        <div className="flex-none h-20 w-full px-6 lg:px-10 flex items-center justify-end">
          {authView !== 'admin' && (
        ...
        <div className="flex-1 overflow-y-auto px-6 sm:px-12 flex flex-col custom-scrollbar">
          <div className="w-full max-w-[380px] mx-auto my-auto py-6">
            ...
            <form onSubmit={(e) => handleAuth(e, authView)}>
              <div className="flex flex-col space-y-4 justify-start">
                ...
                {/* Confirm Password (Hidden for Admin) */}
                {!isLogin && authView !== 'admin' && (
              ...
              {error && (
                <div className="mt-4 p-3 bg-red-500/10 border border-red-500/50 rounded-lg flex items-start gap-2 text-red-400 text-xs">
        ...
        {/* --- BOTTOM FOOTER --- */}
        <div className="flex-none h-16 w-full flex items-center justify-center px-6">
          <div className="flex gap-5 text-[13px] whitespace-nowrap">
            ...
            {authView !== 'student' && (
              <>
                {authView === 'admin' && <div className="w-px h-4 bg-white/10 mt-0.5"></div>}
                <button
