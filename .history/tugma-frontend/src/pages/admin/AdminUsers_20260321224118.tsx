...
import {
  ...
  ShieldAlert, CheckCircle2, Ban, Mail, Edit2, Shield, Loader2, Download
} from 'lucide-react';
                ...
                <tr key={user.id} className="hover:bg-zinc-50 dark:hover:bg-zinc-800/30 transition-colors group">
                  ...
                  <td className="p-4 pr-6 text-right">
                    <div className="flex items-center justify-end gap-2">
                      ...
                      <button className="p-2 text-zinc-400 hover:text-amber-500 hover:bg-amber-50 dark:hover:bg-amber-500/10 rounded-lg transition-colors" title="Edit User">
                        <Edit2 size={16} />
                      </button>
                      {user.role.toLowerCase() !== 'admin' && (
                        <button className="p-2 text-zinc-400 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-500/10 rounded-lg transition-colors" title="Ban User">
                          <Ban size={16} />
                        </button>
                      )}
