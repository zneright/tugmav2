...
export default function AdminReports() {
  ...
  const exportToPDF = () => {
    ...
    doc.setFontSize(20);
    doc.setTextColor(40);
    doc.text("System Audit Trail", 14, 22);
    ...
    // Active Filters Info
    let filterText = `Filters Applied -> Role: ${filterRole}`;
    ...
    autoTable(doc, {
      ...
      headStyles: { fillColor: [220, 38, 38], textColor: 255, fontStyle: 'bold' }, // Matches the Red Admin theme
      ...
      columnStyles: {
        ...
        // Details takes the remaining space automatically
      },
    });
