...
export default function CustomerService() {
  ...
  const handleResolveTicket = async (db_id: number, e: React.MouseEvent) => {
    ...
    try {
      await fetch(`http://localhost:8080/api/admin/tickets/${db_id}/resolve`, { method: 'POST' });
    } catch (error) {
  ...
  // 🔥 NEW: Send the Reply to the Database 🔥
