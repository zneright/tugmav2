...
export default function EmployerJobs() {
  ...
  // 🔥 RESTORED EXACT TIME FORMATTING 🔥
                ...
                <div className="space-y-3 sm:col-span-2 bg-zinc-50 dark:bg-zinc-800/30 p-5 rounded-2xl border border-zinc-200 dark:border-zinc-800">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3">
                    ...
                    {formData.locationSelection === 'Other' && (
                      <input disabled={isReadOnly} name="customLocation" value={formData.customLocation} onChange={handleChange} type="text" placeholder="Type custom location..." className="w-full sm:w-1/2 px-4 py-3 bg-white dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-700 outline-none focus:ring-2 focus:ring-purple-500/30 focus:border-purple-500 text-sm font-medium disabled:opacity-70 animate-in fade-in" />
                    )}
                  </div>
                </div>
