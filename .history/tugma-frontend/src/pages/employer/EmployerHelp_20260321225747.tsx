...
import {
  Search, Building2, ChevronDown, Send, LifeBuoy, Loader2, FileWarning, BookOpen
} from 'lucide-react';
...
export default function EmployerHelp() {
  ...
  const faqs = [
    // Verification & Account
    {
      ...
      answer: "To ensure the safety of our students, all employers must submit a valid Business Permit or Company ID in the 'Company Profile' tab. An admin will review it within 24 hours. Unverified companies may have restricted access to student data."
    },
    {
      question: "Can I add other recruiters to my company account?",
      answer: "Yes. Navigate to 'Team Settings' in your sidebar dropdown. From there, you can invite colleagues via email and assign them Recruiter or Admin roles to help manage your job postings."
    },

    // AI & ATS Features
    {
      question: "How does the AI Resume Screening (ATS) work?",
      answer: "When a student applies, Tugma's Gemini-powered AI instantly extracts text from their attached PDF or DOCX resume and cross-references it with your specific job description. It generates a Match Score (0-100%) and a 2-3 sentence assessment highlighting their strengths and missing keywords."
    },
    {
    ...
    },
    {
      ...
      answer: "Instead of waiting for applicants, go to the 'Smart Job Matchmaker' tab. Enter the skills or concepts you are looking for, and our AI will scan the entire pool of active students, scoring and ranking them based on how well they fit your exact prompt."
    },
    ...
    // Communications & Broadcasting
    {
      ...
      answer: "Yes! Use the 'Communications' tab to send bulk alerts. Our smart targeting allows you to broadcast to all applicants for a specific role, only shortlisted candidates, or specifically blast announcements to your hired, active interns."
    },
    {
      question: "I made a typo in a bulk broadcast. Can I undo it?",
      answer: "Yes. Go to the 'Sent' tab inside Communications. Find the broadcast you want to retract and click the Trash (Unsend) icon. This will instantly and permanently delete the notification from the inboxes of all students who received it."
    },
    {
      question: "How do I private message a single applicant?",
      answer: "Navigate to the 'Communications' tab and look at your Inbox sidebar. Clicking on any applicant's name will open a private, real-time chat window where you can send text messages and request interviews."
    }
  ];
