...
export default function EmployerNotifications() {
  ...
  // 🔥 NEW: Function to view recipients
  const handleViewRecipients = async (n: Notification) => {
    if (viewMode !== 'sent') return;
      ...
      // ... (keep all your existing fetch and handler logic) ...
      ...
      <div className="max-w-4xl mx-auto space-y-6 fade-in relative">
        ...
        {/* ... (Existing Header and Modal logic) ... */}

        {/* --- NOTIFICATIONS LIST (Updated onClick) --- */}
        <div className="space-y-3">
          {filteredList.map((n) => (
            ...
            >
              {/* ... rest of your item content (Icon, Title, Message) ... */}
              ...
              {/* Trash Button Logic stays the same */}
            </div>
          ))}
        </div>
      </div>
