...
export default function EmployerApplicants() {
  ...
  const handleAnalyzeApplicant = async (applicationId: number) => {
    ...
    try {
      ...
      if (!res.ok) {
        throw new Error(result.messages?.error || result.message || result.error || "Unknown Server Error");
      }
      ...
      if (error.message.includes("quota") || error.message.includes("429")) {
        alert("⏳ AI is cooling down!\n\nYou are using the free tier of the AI engine which limits scans to 15 per minute. Please wait about 30 seconds and try again.");
      } else {
  ...
  const startChatWithApplicant = (app: Applicant) => {
    ...
    window.location.href = '/employer/messages'; // Make sure this matches your React Router path
  };
          ...
          <div className="bg-white dark:bg-zinc-900 rounded-3xl w-full max-w-2xl overflow-y-auto max-h-[90vh] shadow-2xl custom-scrollbar border border-zinc-200 dark:border-zinc-800">
            ...
            <div className="relative">
              ...
              <div className="px-6 sm:px-10 pb-6 -mt-12 relative z-10 flex flex-col sm:flex-row gap-5 sm:items-end">
                <div className={`w-24 h-24 rounded-2xl flex items-center justify-center font-black text-4xl border-4 border-white dark:border-zinc-900 shadow-lg shrink-0 ${['bg-blue-100 text-blue-600', 'bg-emerald-100 text-emerald-600', 'bg-purple-100 text-purple-600', 'bg-amber-100 text-amber-600'][getAvatarColor(selectedApplicant.application_id)]}`}>
            ...
            <div className="px-6 sm:px-10 pb-8 space-y-6">
              ...
              <div className="flex items-center justify-between border-b border-zinc-100 dark:border-zinc-800 pb-6">
                <div className="flex items-center gap-3">
                  <button
                    ...
                    className="px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white font-bold text-sm rounded-xl flex items-center gap-2 transition-colors shadow-md"
                  >
                  ...
                  <button
                    ...
                    className="text-sm font-bold text-purple-600 dark:text-purple-400 hover:underline flex items-center gap-1.5 ml-2"
                  >
              ...
              {selectedApplicant.ai_match_score !== null ? (
                ...
                <div className="bg-zinc-50 dark:bg-zinc-800/40 border border-zinc-200 dark:border-zinc-700 p-5 rounded-2xl flex flex-col items-center justify-center text-center">
                  ...
                  <button onClick={() => handleAnalyzeApplicant(selectedApplicant.application_id)} className="mt-3 px-5 py-2 bg-zinc-900 text-white rounded-xl text-sm font-bold flex items-center gap-2 hover:bg-zinc-800 transition-colors">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="bg-zinc-50 dark:bg-zinc-800/40 p-4 rounded-2xl border border-zinc-100 dark:border-zinc-800 flex items-center justify-between">
                  ...
                  {selectedApplicant.resume_data && (
                    <button
                      onClick={() => handleViewResume(selectedApplicant.resume_data)}
                      className="px-4 py-2 bg-zinc-900 hover:bg-black text-white text-xs font-bold rounded-xl transition-colors shrink-0 flex items-center gap-1"
                    >
              ...
              return (
                <div key={app.application_id} className="grid grid-cols-1 md:grid-cols-12 gap-4 p-4 md:p-5 items-center hover:bg-zinc-50 dark:hover:bg-zinc-800/30 transition-colors group">
                  ...
                  <div className="col-span-1 md:col-span-3 flex items-center gap-4">
                    <div className={`w-12 h-12 rounded-2xl flex items-center justify-center font-black text-lg shrink-0 ${['bg-blue-100 text-blue-600', 'bg-emerald-100 text-emerald-600', 'bg-purple-100 text-purple-600', 'bg-amber-100 text-amber-600'][getAvatarColor(app.application_id)]}`}>
                  ...
                  <div className="col-span-1 md:col-span-2 flex flex-col md:block min-w-0">
                  ...
                  <div className="col-span-1 md:col-span-1 flex md:justify-center">
                    <span className="md:hidden text-[10px] font-bold text-zinc-400 uppercase tracking-wider mb-1 block w-full">Resume</span>
                    {app.resume_data ? (
                      <button
                        onClick={(e) => { e.stopPropagation(); handleViewResume(app.resume_data); }}
                        title="Download CV"
                        className="p-2 text-purple-600 bg-purple-50 hover:bg-purple-100 dark:bg-purple-500/10 dark:hover:bg-purple-500/20 rounded-xl transition-colors"
                      >
                        <Download size={16} />
                      </button>
                    ) : (
                  ...
                  <div className="col-span-1 md:col-span-2 flex items-center justify-end gap-2 mt-4 md:mt-0">
                    <button onClick={() => startChatWithApplicant(app)} title="Message Applicant" className="p-2 bg-zinc-100 hover:bg-zinc-200 dark:bg-zinc-800 dark:hover:bg-zinc-700 text-zinc-600 dark:text-zinc-300 rounded-xl transition-colors shadow-sm">
