...
export default function EmployerHelp() {
  ...
  const faqs = [
    ...
    // Communications & Broadcasting
    {
      ...
      answer: "Yes! Use the 'Notif' tab to send bulk alerts. Our smart targeting allows you to broadcast to all applicants for a specific role, only shortlisted candidates, or specifically blast announcements to your hired, active interns."
    },
    {
