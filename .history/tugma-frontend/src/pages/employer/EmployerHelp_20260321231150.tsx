...
export default function EmployerHelp() {
  ...
  const [searchQuery, setSearchQuery] = useState(''); // 🔥 State is named setSearchQuery
        ...
        <div className="relative z-10">
          ...
          <div className="max-w-xl mx-auto relative group">
            ...
            <input
              type="text"
              value={searchQuery}
              onChange={(e) => setSearchQuery(e.target.value)} // 🔥 FIXED: Changed to setSearchQuery
            ...
            {searchQuery && (
              <button
                onClick={() => setSearchQuery('')} // 🔥 FIXED: Changed to setSearchQuery
