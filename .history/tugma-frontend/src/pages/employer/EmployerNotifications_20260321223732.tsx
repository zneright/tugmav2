...
export default function EmployerNotifications() {
  ...
  // 🔥 UPDATED: Replaced red with amber to match the palette
  const getIcon = (type: string) => {
    switch (type) {
      ...
      case 'alert': return <ShieldAlert size={18} className="text-amber-500" />; // Admin Broadcasts
      ...
      <div className="space-y-3">
        {filteredList.length === 0 ? (
          ...
          filteredList.map((n) => {
            ...
            // 🔥 Dynamic styling swapped to amber
            ...
            return (
              ...
              >
                ...
                {viewMode === 'inbox' ? (
                  <button onClick={() => handleDeleteInbox(n.id)} className="p-2 text-zinc-300 hover:text-purple-500 hover:bg-purple-50 dark:hover:bg-purple-500/20 rounded-xl transition-colors opacity-0 group-hover:opacity-100">
                    <Trash2 size={16} />
                  </button>
                ) : (
