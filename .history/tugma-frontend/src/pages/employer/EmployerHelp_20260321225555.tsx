...
export default function EmployerHelp() {
  ...
  // 🔥 CUSTOM TUGMA EMPLOYER FAQS 🔥
  const faqs = [
    {
      question: "How does the AI Resume Screening (ATS) work?",
      answer: "When a student applies, Tugma's Gemini-powered AI instantly scans their attached resume and profile against your specific job description. It generates a Match Score (0-100%) and a quick assessment highlighting their strengths and missing keywords to speed up your hiring process."
    },
    {
      question: "How do I officially hire a student and start their OJT?",
      answer: "Go to your Applications Pipeline, select the applicant, and change their status to 'Hired'. This automatically moves them into your 'Managed Interns' roster and activates their Daily Time Record (DTR) tracker on their end."
    },
    {
      question: "How do I track and print an intern's DTR?",
      answer: "In the 'Managed Interns' tab, you can view the live progress of all your active interns' logged hours. Once they are done (or at any time), click the Printer icon next to their name to automatically generate and download their official DTR PDF for your signature."
    },
    {
      question: "Can I broadcast messages to multiple applicants at once?",
      answer: "Yes! Use the 'Notifications' tab to send bulk alerts. You can intelligently target all applicants for a specific role, only shortlisted candidates, or specifically blast announcements to your hired, active interns."
    },
    {
      question: "How does the AI Matchmaker help students find my jobs?",
      answer: "The AI Matchmaker reads your company's Job Description, Required Skills, and Work Setup, and cross-references it with student profiles. To get the best applicants, ensure your Job Postings are detailed and your Company Profile highlights your perks accurately."
    }
  ];
