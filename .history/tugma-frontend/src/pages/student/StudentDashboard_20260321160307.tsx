        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-8">
          ...
          {isHired && (
            <div className="shrink-0 bg-emerald-950/50 backdrop-blur-md p-6 rounded-3xl border border-emerald-800 w-full md:w-auto text-center shadow-inner">
              ...
              <button
                onClick={() => window.location.href = '/student/ojttracker'}
                className="w-full py-3.5 bg-emerald-500 hover:bg-emerald-600 text-white rounded-xl text-sm font-bold flex items-center justify-center gap-2 transition-all shadow-lg shadow-emerald-500/20 hover:scale-105 active:scale-95"
              >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 animate-in slide-in-from-bottom-4 duration-700">
          ...
          <div className="space-y-6">
            <div className="bg-emerald-600 rounded-3xl p-6 text-white shadow-xl shadow-emerald-500/20">
              ...
              <button
                onClick={() => window.location.href = '/student/ojt-tracker'}
                className="w-full py-2.5 bg-white text-emerald-700 rounded-xl text-sm font-black hover:bg-emerald-50 transition-colors"
              >
                Go to Tracker
              </button>
            </div>
