...
export default function StudentProfile() {
  ...
  // 🔥 NEW: State for storing DTR Logs
      ...
      const unsubscribe = auth.onAuthStateChanged(async (user) => {
        if (user) {
          try {
            ...
            // 🔥 2. Fetch DTR Logs to show "Logged Data"
            ...
            setProfileData(prev => ({
              ...
              ojt: {
                ...prev.ojt,
                ...(data.ojt || {}),
                completedHours: calculatedHours // Set calculated hours from DB
              },
              skills: data.skills || [],
  ...
  return (
    <div className="space-y-6 pb-20 md:pb-8 animate-in fade-in duration-500 max-w-5xl mx-auto">
      ...
      {/* Header Profile Section (No changes needed here, kept intact) */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-6">
          ...
          {/* 🔥 ENHANCED: OJT Hub with Progress Bar & Print 🔥 */}
