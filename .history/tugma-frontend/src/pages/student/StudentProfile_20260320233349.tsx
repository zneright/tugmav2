            ...
            <div className="space-y-6 relative ...">
              {[
                ...
                <div key={edu.key} className="relative flex items-center ...">
                  <div className="flex items-center justify-center w-6 h-6 ... bg-purple-500 z-10"></div>
                  <div className="w-[calc(100%-3rem)] ... bg-white dark:bg-zinc-900 p-5 rounded-2xl border border-zinc-200 dark:border-zinc-700">
