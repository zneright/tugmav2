...
export default function Dashboard() {
  ...
  const handlePrintDTR = () => {
    ...
    logSystemEvent('Generated DTR Document', `Printed Official DTR Log Sheet with ${ojtData.completed}/${ojtData.required} hours validated.`);
  ...
  const onboardingStepsCompleted = 1 + (hasStartedLogging ? 2 : 0); 
