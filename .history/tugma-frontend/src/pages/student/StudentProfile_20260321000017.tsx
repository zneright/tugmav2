          ...
          try {
            ...
            if (response.ok) {
              ...
              setProfileData({
                ...
                classification: data.classification || "Information Technology & Computer Science",
                course: data.course || "",
                ...
                // Ensure objects/arrays aren't null
                education: data.education || { elementary: { school: "", years: "" }, highSchool: { school: "", years: "" }, seniorHighSchool: { school: "", years: "" }, college: { school: "", years: "" } },
                ojt: data.ojt || { status: "Actively Looking", requiredHours: 450, completedHours: 0 },
                skills: data.skills || [],
