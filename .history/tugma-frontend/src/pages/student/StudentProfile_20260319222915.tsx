...
import {
  ...
  Briefcase, BookOpen, Target, Loader2, ChevronDown, User
} from 'lucide-react';
...
export default function StudentProfile() {
          ...
          try {
            ...
            if (response.ok) {
              ...
              setProfileData(prev => ({
                ...prev,
                ...data,
                // Ensure we map the database 'address' or fallback to 'location' if old data exists
  ...
  // Common Input Styles for perfect alignment
        ...
        <div className="px-5 sm:px-8 pb-8 relative">
          <div className="flex justify-between items-end -mt-12 sm:-mt-16 mb-6 relative z-10">
            <div className="relative group cursor-pointer">
              <div className="w-24 h-24 sm:w-32 sm:h-32 rounded-full border-[5px] border-white dark:border-zinc-900 bg-zinc-200 dark:bg-zinc-800 flex items-center justify-center overflow-hidden shadow-md">
