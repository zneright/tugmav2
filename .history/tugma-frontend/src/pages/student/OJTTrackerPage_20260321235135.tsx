                ...
                try {
                    ...
                    if (profileRes.ok) {
                        ...
                        if (profileData.ojt) {
                            ...
                            // 🔥 FIX: Default to Actively Looking instead of In Progress!
                            // Now it stays locked even if they get rejected, until an employer clicks "Hire"
                    ...
                    {status === 'In Progress' ? (
                        ...
                        <div className="text-center py-12">
                            ...
                            <p className="text-sm text-zinc-500">
                                {status === 'Rejected'
                                    ? "Your application for this role was not successful. Keep applying!"
                                    : "You'll be able to log hours once you accept an official job offer."}
                            </p>
                        </div>
                    )}
                    {/* ---------------- IN PROGRESS STATE ---------------- */}
