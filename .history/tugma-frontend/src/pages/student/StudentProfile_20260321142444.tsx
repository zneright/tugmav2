...
export default function StudentProfile() {
  ...
  const handleDownloadResume = (e: React.MouseEvent) => {
    ...
    const downloadUrl = profileData.resumeData.replace('/upload/', '/upload/fl_attachment/');

    // By changing the CURRENT window location to a download link, 
    // the browser downloads the file without leaving the React app 
    // and completely bypasses the Dev Environment's pop-up blocker!
    ...
    <div className="space-y-6 pb-20 md:pb-8 animate-in fade-in duration-500 max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          ...
          {/* 👇 FIX: RESUME SECTION USING ANCHOR TAG 👇 */}
          <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800 p-6 shadow-sm">
            ...
            <div className="flex flex-col gap-3 p-4 bg-purple-50 dark:bg-purple-500/10 border border-purple-100 dark:border-purple-500/20 rounded-xl mb-4">
              ...
              {profileData.resumeData && !isEditing && (
                <a
                  /* 🔥 THE FIX: Inject fl_attachment to force a safe download and bypass the Chrome PDF Viewer crash 🔥 */
                  href={profileData.resumeData.replace('/upload/', '/upload/fl_attachment/')}
                  target="_blank"
