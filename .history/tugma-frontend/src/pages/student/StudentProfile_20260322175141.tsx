...
import {
  ...
  Trash2, AlertTriangle // <-- Delete icons
} from 'lucide-react';
...
export default function StudentProfile() {
  ...
  return (
    <div className="space-y-6 pb-20 md:pb-8 animate-in fade-in duration-500 max-w-5xl mx-auto">
      ...
      {/* --- NEW: Danger Zone (Placed at the bottom, outside editing state) --- */}
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
            <div>
              ...
              <p className="text-[13px] text-zinc-600 dark:text-zinc-400 font-medium max-w-2xl leading-relaxed">
                Deleting your account will permanently remove your login access, delete your active profile, and archive your data. This action cannot be undone.
              </p>
            </div>
            <button
