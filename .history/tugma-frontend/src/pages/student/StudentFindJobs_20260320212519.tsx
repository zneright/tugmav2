  ...
  import { Search, MapPin, Filter, Clock, Building2, ChevronRight, CheckCircle2, Eye, Calendar, Sparkles, AlertCircle, Loader2, Tag, X, ShieldAlert } from 'lucide-react';
  ...
  export default function FindJobs() {
    ...
    const confirmAndSubmitApplication = async () => {
      ...
      try {
        // Future DB connection will go here:
        // await fetch('http://localhost:8080/api/applications/apply', { method: 'POST', body: JSON.stringify({ job_id: jobToApply.id, student_uid: uid }) });

        // Simulate network request for the hackathon
