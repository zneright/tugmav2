    ...
    const fetchInteractions = async (studentUid: string) => {
        try {
            ...
            if (res.ok) {
                ...
                // If API returns an array of application objects with statuses
                ...
                {jobs.length === 0 ? (
                    ...
                    <div className="grid grid-cols-1 gap-4">
                        {jobs.map((job) => {
                            ...
                            // Determine the current status of the job and application
                                    ...
                                    <div className="flex-1 min-w-0 flex flex-col justify-center">
                                        ...
                                        <div className="mt-3 flex flex-wrap gap-2">
                                            {jobSkills.slice(0, 4).map((skill: string) => (
                                                <span key={skill} className="text-[10px] font-bold uppercase tracking-wider px-2 py-1 bg-zinc-100 dark