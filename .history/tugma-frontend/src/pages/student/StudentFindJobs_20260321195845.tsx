    ...
    <div className="space-y-6 pb-20 md:pb-8 animate-in fade-in duration-500 relative max-w-5xl mx-auto">
      ...
      {jobToApply && (
        <div className="fixed inset-0 z-[70] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 animate-in fade-in">
          <div className="bg-white dark:bg-zinc-900 rounded-3xl w-full max-w-md p-6 shadow-2xl border border-zinc-200 dark:border-zinc-800 relative overflow-hidden flex flex-col mx-auto">
      ...
      {selectedJob && studentProfile && (
        <div className="fixed inset-0 z-[50] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 animate-in fade-in">
          <div className="bg-white dark:bg-zinc-900 rounded-3xl w-full max-w-lg overflow-y-auto max-h-[90vh] shadow-2xl custom-scrollbar border border-zinc-200 dark:border-zinc-800 flex flex-col mx-auto">
            <div className="h-32 sm:h-40 w-full relative shrink-0">
              <img src={selectedJob.image_url || 'https://images.unsplash.com/photo-1498050108023-c5249f4df085?auto=format&fit=crop&w=800&q=80'} alt="Cover" className="w-full h-full object-cover rounded-t-3xl" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent rounded-t-3xl" />
              <button onClick={() => setSelectedJob(null)} className="absolute top-4 right-4 p-2 bg-black/40 text-white rounded-full hover:bg-black/60 backdrop-blur-md transition-colors active:scale-95">
                <X size={18} />
              </button>
            </div>

            <div className="px-4 sm:px-6 pb-6 -mt-8 relative z-10 flex-1">
            ...
            <div className="p-4 sm:p-6 sticky bottom-0 bg-white/90 dark:bg-zinc-900/90 backdrop-blur-md border-t border-zinc-100 dark:border-zinc-800 shrink-0">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          <div className="relative group w-full">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3 sm:py-3.5 text-sm font-medium bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-2xl focus:outline-none focus:ring-2 focus:ring-purple-500/30 focus:border-purple-500 transition-all dark:text-white"
            />
          </div>
