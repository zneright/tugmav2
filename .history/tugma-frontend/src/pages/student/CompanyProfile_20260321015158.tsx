...
export default function CompanyProfile({ employerUid, onBack }: CompanyProfileProps) {
    ...
    // 👇 NEW: Fetch jobs already applied to 👇
    ...
    const confirmAndSubmitApplication = async () => {
        ...
        try {
            // 1. Record in interactions table for the student view
            ...
            // 2. Submit actual application to the employer's dashboard
    ...
    return (
        <div className="max-w-5xl mx-auto space-y-6 fade-in pb-10 relative">
            ...
            {/* --- RECENT POSTINGS SECTION WITH APPLY BUTTON --- */}
