  ...
  return (
    <>
      ...
      `}>
        ...
        {/* LOGO & PROFILE FOOTER */}
        <div className="p-4 border-t border-zinc-200 dark:border-zinc-800 shrink-0 flex flex-col gap-4">
          <div className="flex justify-center pt-2 pb-1">
            <img src={tugmaLogo} alt="Tugma Logo" className="h-10 object-contain dark:invert-0 invert opacity-70 hover:opacity-100 transition-opacity" />
          </div>
