...
export default function Topbar({ toggleSidebar }: TopbarProps) {
  ...
  // 🔥 FETCH USER PROFILE FOR PICTURE/INITIALS
    ...
    try {
      ...
      if (isEmployer) {
        ...
        if (res.ok) {
          ...
          // 🔥 Check for student photo (Handles both base64 and URLs like Cloudinary)
      ...
      <div className="flex items-center gap-2 sm:gap-4">
        ...
        <div className="relative" ref={profileRef}>
          <button
            ...
            // 🔥 FIXED: w-9 h-9, perfectly round, strict overflow hidden to trap the image
          ...
          >
            {/* 🔥 FIXED: Cloudinary Link / Base64 perfectly covers the circle */}
            {avatarImage ? (
              <img
                src={avatarImage}
                alt="Profile"
                ...
                onError={(e) => {
                  // Fallback just in case the Cloudinary link breaks
