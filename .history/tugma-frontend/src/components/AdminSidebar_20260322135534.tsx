      ...
      `}>
        ...
        <div className="h-16 flex items-center justify-center px-4 border-b border-zinc-200 dark:border-zinc-800 shrink-0 relative">
          <div className="flex items-center gap-3">
            <img src={tugmaLogo2} alt="Tugma Logo" className="h-5 w-auto object-contain drop-shadow-sm" />
            <span className="text-2xl font-black text-zinc-900 dark:text-white tracking-tight flex items-center gap-2.5">
